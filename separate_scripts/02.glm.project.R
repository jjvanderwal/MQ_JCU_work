...
# source my modified version of biomod2's BIOMOD_Projection.R for different outputs
...
if (project.glm) {
	...
	if (!is.null(glm.obj)) {
		...
		glm.proj = my.BIOMOD_Projection(modeling.output=glm.obj, new.env=predictors, proj.name=es.name, 
