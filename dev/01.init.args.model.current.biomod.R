...
#
biomod.NbRunEval=1  # n-fold cross-validation; ignored if DataSplitTable is filled
...
save.image(paste(wd, "/01.init.args.model.current.biomod.", species, ".RData", sep=""))
save.image(paste(wd, "/01.init.args.model.current.biomod.", species, ".Rascii", sep=""), ascii=TRUE) # for Daniel